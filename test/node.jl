module Testnode
using CrystalShift: Node, add_child!, get_nodes_at_level
using CrystalShift: is_immidiate_child, is_child, get_level
using CrystalShift: get_phase_ids, check_same_phase, remove_child!,get_node_with_id
