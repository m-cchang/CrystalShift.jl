...
using Test
using CrystalShift
using CrystalShift: approximate_negative_log_evidence, get_probabilities
using CrystalShift: bestfirstsearch, find_first_unassigned, get_phase_ids, res_bfs
using CrystalShift
...
method = LM
objective = CrystalShift.LeastSquares()
